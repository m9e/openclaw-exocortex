...
const config = {
  ...
  ignoreIssues: {
    ...
    // Fork integrations expose cache reset and startup-policy seams to focused tests;
    // the full-tree companion still checks that every export has a real consumer.
    "extensions/kamiwaza/src/client.ts": ["exports"],
    "extensions/kamiwaza/src/config.ts": ["exports"],
    "extensions/locksmith/src/client.ts": ["exports"],
    "extensions/slack/src/client.ts": ["exports"],
    "extensions/untrusted-content/src/breaker-notify.ts": ["exports"],
    "extensions/untrusted-content/src/channel-guard.ts": ["exports"],
    "extensions/untrusted-content/src/config.ts": ["exports"],
    "extensions/untrusted-content/src/risk.ts": ["exports"],
    "extensions/untrusted-content/src/summarize.ts": ["exports"],
    "src/gateway/locksmith-requirement.ts": ["exports"],
