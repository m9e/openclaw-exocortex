...
import { createMemoryGraphViewState, renderMemoryGraph } from "./memory-graph.ts";
...
class AgentMemoryPanel extends OpenClawLightDomElement {
  ...
  private readonly graphViewState = createMemoryGraphViewState();
  ...
  private resetTransientState() {
    ...
    Object.assign(this.graphViewState, createMemoryGraphViewState());
    ...
    return html`
      ...
      ${renderDreaming({
        graph: renderMemoryGraph({
          viewState: this.graphViewState,
          selectedAgentId,
          agentOptions: [{ id: selectedAgentId, label: selectedAgentId }],
          loading: dreaming.dreamingStatusLoading,
          statusError: dreaming.dreamingStatusError,
          wikiLoading: dreaming.wikiOverviewLoading,
          wikiError: dreaming.wikiOverviewError,
