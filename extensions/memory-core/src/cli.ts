...
export function registerMemoryCli(program: Command) {
  ...
  memory
    .command("promote")
    .description(
      "Rank short-term recalls and optionally append top entries to the promotion target",
    )
    .option("--agent <id>", "Agent id (default: default agent)")
    ...
    .option("--apply", "Append selected candidates to the configured promotion target", false)
