...
import type { SampleAssociativeRecallCandidatesResult } from "@openclaw/memory-core/api.js";
...
vi.mock("@openclaw/memory-core/api.js", () => ({
...
describe("active-memory plugin", () => {
  ...
  beforeEach(async () => {
    ...
    hoisted.sampleAssociativeRecallCandidates
      .mockReset()
      .mockResolvedValue({ storePath: "", eligibleCount: 0, selected: [] });
    configFile = {
