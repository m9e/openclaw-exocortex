...
/** Exact ids emitted by Codex's flat_tool_name at the native hook boundary. */
export function getCodexDynamicToolHookNames(specs: readonly CodexDynamicToolSpec[]): string[] {
