import { requiresAgentToolResultReplacement } from "openclaw/plugin-sdk/agent-harness-runtime";
...
export function resolveCodexWebSearchPlan(params: {
  ...
  const nativeSearchEnabled =
    // Hosted search runs inside the provider and has no replaceable result callback.
    !requiresAgentToolResultReplacement("codex", "web_search") &&
