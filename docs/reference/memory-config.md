...
| `phases.deep.promotionTargetPath`       | `string`  | `MEMORY.md`   | Workspace-relative promotion destination; use `memory/promoted.md` to keep bootstrap memory separately curated                   |
